...
my $maf=$ARGV[0];
my $output="$ARGV[1]/cattle.maf.lst";
my $ref="Cattle";
#my @species=("goat","Cattle",$ARGV[1]);
my @species=("Cattle","Cervus_elaphus","Rangifer_tarandus","Cervus_nippon","Elaphurus_davidianus","Dama_dama","Moschus_berezovskii","Cervus_albirostris","Muntiacus_reevesi","Giraffe","Rusa_unicolor","Hydropotes_inermis");

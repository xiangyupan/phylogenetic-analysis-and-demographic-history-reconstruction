...
my $gff ="/stor9000/apps/users/NWSUAF/2016050001/RSCE_Comparative_genome/Cervidae/02.multiz/02.4dtv/cattle.4dtv.gff";
#my $gff="/home/chenlei/project/ruminant/31.annotation/data_pep/Bos_taurus.UMD3.1.87.gff3.check.gff";
my $lst=$ARGV[0];
my $dir="genes";
`mkdir $dir` if(!-e $dir);
